...
Работа помогла разобраться с разложением функций в ряды Фурье. Квадратная волна хорошо аппроксимируется суммой синусов и косинусов — уже с тремя гармониками видно, как форма приближается к исходной функции.

Комплексная форма оказалась удобнее для расчётов. Программа на Python быстро считает коэффициенты для любого количества гармоник. Графики показывают, что обе формы дают одинаковый результат.

Проверил равенство Парсеваля — энергия сигнала действительно равна сумме энергий гармоник. Это подтверждает правильность вычислений.
