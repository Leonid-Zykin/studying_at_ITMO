...
Изучены свойства Фурье-преобразования и их применение в анализе сигналов.

\textbf{Основные результаты:}

\begin{enumerate}
    \item \textbf{Функции и их Фурье-образы:} прямоугольная → sinc, треугольная → быстрое убывание, sinc → прямоугольный, Гаусс → Гаусс, экспонента → Лоренц
    \item \textbf{Принцип неопределённости:} ширина функции обратно пропорциональна ширине спектра
    \item \textbf{Свойство сдвига:} временной сдвиг соответствует фазовому сдвигу в частотной области
    \item \textbf{Практическое применение:} анализ музыкального аккорда методом численного интегрирования
\end{enumerate}

\textbf{Полученные навыки:} математические методы нахождения Фурье-образов, работа с численными методами, интерпретация спектрального анализа.

Работа заложила основу для изучения методов обработки сигналов, цифровой фильтрации и спектрального анализа.
