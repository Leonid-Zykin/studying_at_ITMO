...
Теперь понимаю, как работает преобразование Фурье. Каждая функция даёт свой характерный спектр: прямоугольная превращается в sinc, треугольная быстро затухает, а Гаусс остаётся Гауссом.

Принцип неопределённости работает на практике — узкий импульс даёт широкий спектр и наоборот. Сдвиг функции во времени просто добавляет фазу в спектре, модуль не меняется.

Самое интересное — анализ музыкального аккорда. Численное интегрирование помогло найти все ноты: D#, G, A# в разных октавах. Спектр получился чёткий, видно каждую частоту.

Работа показала, что Фурье-преобразование — мощный инструмент для анализа сигналов. Теперь могу разбирать сложные функции на простые гармоники.
