...
В расчётах использованы следующие матрицы $A$ (каждая матрица не является диагональной или жордановой, за исключением случаев с вещественными кратными собственными числами, где специально показаны эффекты масштабирования):

\begin{align}
A_1 &= \begin{pmatrix} -1 & 0 \\ 0 & -1 \end{pmatrix}, &
A_2 &= \begin{pmatrix} -\tfrac{1}{\sqrt{2}} & -\tfrac{1}{\sqrt{2}} \\ \tfrac{1}{\sqrt{2}} & -\tfrac{1}{\sqrt{2}} \end{pmatrix}, &
A_3 &= \begin{pmatrix} 0 & -1 \\ 1 & 0 \end{pmatrix}, \\
A_4 &= \begin{pmatrix} \tfrac{1}{\sqrt{2}} & -\tfrac{1}{\sqrt{2}} \\ \tfrac{1}{\sqrt{2}} & \tfrac{1}{\sqrt{2}} \end{pmatrix}, &
A_5 &= \begin{pmatrix} 1 & 0 \\ 0 & 1 \end{pmatrix}. &&
\end{align}

Масштабированные системы:
\begin{align}
A_6 &= 0.5\,A_1 = \begin{pmatrix} -0.5 & 0 \\ 0 & -0.5 \end{pmatrix}, &
A_8 &= 0.5\,A_3 = \begin{pmatrix} 0 & -0.5 \\ 0.5 & 0 \end{pmatrix}, &
A_{10} &= 0.5\,A_5 = \begin{pmatrix} 0.5 & 0 \\ 0 & 0.5 \end{pmatrix}, \\
A_9 &= 2\,A_1 = \begin{pmatrix} -2 & 0 \\ 0 & -2 \end{pmatrix}, &
A_{11} &= 2\,A_3 = \begin{pmatrix} 0 & -2 \\ 2 & 0 \end{pmatrix}, &
A_{13} &= 2\,A_5 = \begin{pmatrix} 2 & 0 \\ 0 & 2 \end{pmatrix}, \\
A_{12} &= \begin{pmatrix} 0 & 0 \\ 0 & 0 \end{pmatrix}. &&
\end{align}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/task2/system8_lambda_pure_imaginary_scaled.png}
    \caption{Система 8: $\lambda_{1,2} = 0.5\cdot(\pm i)$}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/task2/system10_lambda_plus1_scaled.png}
    \caption{Система 10: $\lambda_{1,2} = 0.5\cdot 1$}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/task2/system11_lambda_pure_imaginary_scaled_up.png}
    \caption{Система 11: $\lambda_{1,2} = 2\cdot(\pm i)$}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/task2/system13_lambda_plus1_scaled_up.png}
    \caption{Система 13: $\lambda_{1,2} = 2\cdot 1$}
\end{figure}
