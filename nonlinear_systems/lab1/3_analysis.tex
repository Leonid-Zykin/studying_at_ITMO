...
Для систем 3 и 4 проведен анализ предельных циклов с использованием перехода к полярным координатам.

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{limit_cycles/limit_cycles_система_3.png}
\caption{Фазовый портрет системы 3 с анализом предельных циклов}
\label{fig:limit_cycles_system3}
\end{figure}
